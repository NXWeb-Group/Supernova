<template>
  ...
  <footer class="fixed bottom-0 left-0 p-1 space-x-3">
    <button class="text-xl font-poppins text-white hover:text-darker-blue" @click="this.$emit('credits')">Credits</button>
    <button class="text-xl font-poppins text-white hover:text-darker-blue" @click="this.$emit('tos')">Terms of service</button>
